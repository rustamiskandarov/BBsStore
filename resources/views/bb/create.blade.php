        ...
        <div class="col">
            <form action="{{route('bb.store')}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" value="{{old('title')}}" class="form-control @error('title') is-invalid @enderror" id="titleInput" aria-describedby="titleHelp">
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="contentInput" rows="3">{{old('content')}}</textarea>
                    @error('content')
                    <span class="invalid-feedback"><strong>{{$message}}</strong></span>
                    @enderror
                </div>
                ...
                <div class="mb-3 row">
                    <div class="col">
                        ...
                        <input type="number" value="{{old('price')}}" name="price" class="form-control @error('price') is-invalid @enderror" id="priceInput" aria-describedby="titleHelp">
                        @error('price')
                        <span class="invalid-feedback"><strong>{{$message}}</strong></span>
                        @enderror
                    ...
                    <div class="col">
                        ...
                        <input type="number" value="{{old('quantity')}}" name="quantity" class="form-control @error('quantity') is-invalid @enderror" id="quantityInput" aria-describedby="quantityHelp">
                        @error('quantity')
                        <span class="invalid-feedback"><strong>{{$message}}</strong></span>
                        @enderror
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="unit" value="{{old('unit')}}" class="form-control @error('unit') is-invalid @enderror" id="unitInput" aria-describedby="unitHelp">
                        @error('unit')
                        <span class="invalid-feedback"><strong>{{$message}}</strong></span>
                        @enderror
